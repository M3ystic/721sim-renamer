...
private:
	...
	/////////////////////////////////////////////////////////////////////
	std::vector<uint64_t> rename_map_table;

	/////////////////////////////////////////////////////////////////////
	// Structure 2: Architectural Map Table
	// Entry contains: physical register mapping
	/////////////////////////////////////////////////////////////////////
	std::vector<uint64_t> arch_map_table;
	...
	typedef struct {
		...
		bool head_phase = 0;
		bool tail_phase = 1;
		//uint64_t free_reg_count;
		std::vector<uint64_t> phys_reg;
	} free_list_t;
	...
	typedef struct {
		...
		bool b_mispred = false;
		bool v_mispred = false;
		bool is_load = false;
		bool is_store = false;
	...
	std::vector<active_list_entry> active_list;
	uint16_t al_head = 0;
	uint16_t al_tail = 0;
	bool al_head_phase = 0;
	bool al_tail_phase = 0;
	/////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////
	typedef struct {
		std::vector<uint64_t> shadow_table;
		uint64_t fl_head = 0;
		bool fl_head_phase = false;
	 // bool fl_tail_phase;	
		uint64_t gbm_snapshot = 0ULL;
	} branch_checkpoint_t;

	std::vector<branch_checkpoint_t> gbm_mask;
	//uint64_t free_checkpoints;
...
public:
	...
	void write_gbm(uint64_t branch_ID);
	void clear_gbm(uint64_t branch_ID);

	uint64_t count_gbm_zeroes();

	uint64_t get_branch_id();
